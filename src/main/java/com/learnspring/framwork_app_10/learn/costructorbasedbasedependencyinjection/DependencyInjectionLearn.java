package com.learnspring.framwork_app_10.learn.costructorbasedbasedependencyinjection;
...
class BuisnesClass{
	...
	@Autowired //here are autowired so we get object this is Constructor based Injection
	BuisnesClass(Dependency1 dependency1, Dependency2 dependency2)
	{
